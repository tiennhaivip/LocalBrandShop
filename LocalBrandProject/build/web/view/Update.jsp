                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="update" method="post">
                            ...
                            <div class="form-group">
                                <label>Status</label>
                                <input value="${product.status}" name="status" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Add date</label>
                                <input value="${product.adddate}" name="adddate" type="date" class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <c:forEach items="${requestScope.dataC}" var="o">
                                        <option ${product.cat_id} value="${o.id}">${o.name}</option>
